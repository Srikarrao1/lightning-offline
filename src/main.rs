...
async fn main() -> anyhow::Result<()> {
    ...
    local.run_until(async {
        ...
        let database_url =
            env::var("DATABASE_URL").unwrap_or_else(|_| "sqlite:./data/lightning.db".to_string());
    ...
    Err(e) => {
        ...
        let channel_manager = match ChannelManager::new(key_manager.clone(), database.clone()).await {
